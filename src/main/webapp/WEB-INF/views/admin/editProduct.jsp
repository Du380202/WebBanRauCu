        ...
        <div class="row">
            ...
            <div class="col-md-9 main-content">
               <div class="shopping-cart mb-4">
            	 ...
            	 <form:form action="EditProduct" modelAttribute="editProduct">
            	 <p>${messageEP}</p>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <form:input type="text" class="form-control" id="name" placeholder="Product ID" path="ProductID"/>
                                <label for="name">ProductID</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <form:input type="text" class="form-control" id="subject" placeholder="Product Name" path="ProductName"/>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <form:input type="text" class="form-control" id="subject" placeholder="Link Image" path="Img"/>
                                <label for="name">Link Image</label>
                            </div>
                        </div>
                       <div class="col-12">
                            <div class="form-floating">
                                <form:textarea style="height:200px"  type="text" class="form-control" id="subject" placeholder="Subject" path="Description"/>
