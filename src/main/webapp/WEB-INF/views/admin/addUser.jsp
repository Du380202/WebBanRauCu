        ...
        <div class="row">
            ...
            <div class="col-md-9 main-content">
               <div class="shopping-cart mb-4">
            		...
            		<form:form action="AddUser" modelAttribute="users">
            		<p>${messageAddU}</p>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <form:input type="text" class="form-control" id="name" placeholder="User Name" path="UserName"/>
                                <label for="name">User Name</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <form:input type="text" class="form-control" id="subject" placeholder="Password" path="password"/>
